			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<select name="Program_Studi" class="form-control" required>
						...
						<option value="Teknik Pengolahan Sawit" <?php if($data['Program_Studi'] == 'Teknik Pengolahan Sawit'){ echo 'selected'; } ?>>Teknik Pengolahan Sawit</option>
						<option value="Perawatan Perbaikan Mesin" <?php if($data['Program_Studi'] == 'Perawatan Perbaikan Mesin'){ echo 'selected'; } ?>>Perawatan Perbaikan Mesin</option>
					</select>
				</div>
			</div>
			<div class="item form-group">
