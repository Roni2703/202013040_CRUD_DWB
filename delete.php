...
if(isset($_GET['Nim'])){
	...
	if(mysqli_num_rows($cek) > 0){
		...
		if($del){
			echo '<script>alert("Berhasil mengahapus data."); document.location="index.php?page=tampil_mhs";</script>';
		}else{
			echo '<script>alert("Gagal mengahapus data."); document.location="index.php?page=tampil_mhs";</script>';
		}
	}else{
